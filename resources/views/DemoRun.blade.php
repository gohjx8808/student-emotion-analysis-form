...
<body class="background">
    <div class="form-background">
        ...
        <br />
        <h4 class="white-label">Demo Run</h4>
        <p class="white-label">
            Please answer the questions as best as you can. Good luck!
        </p>
        <hr style="background-color:white" />
        <p class="white-label"><u>Demo Run</u></p>
        <form action="QDemo/save" method="POST">
            {{ csrf_field() }}
            <div class="form-group">
                <div>
                    ...
                    <div class="programming-bg">
                        <span class="programming-blue">public class QDemo</span><br />
                        {<br />
                    ...
                    <div class="form-control" style="border-bottom-width: 0;border-radius: 10px 10px 0px 0px;">
                        <input class="form-control-input" type="radio" id="QDemo_1a" name="QDemo_1" value="a" required
                            {{old("QDemo_1")=='a'?'checked':''}} {{old("flag")?'disabled':''}} />
                        <label class="form-check-label" for="QDemo_1a" style="padding-left: 15px;">
                            180
                        </label>
                    </div>
                    <div class="form-control radio-center">
                        <input class="form-control-input" type="radio" id="QDemo_1b" name="QDemo_1" value="b"
                            {{old("QDemo_1")=='b'?'checked':''}} {{old("flag")?'disabled':''}} />
                        <label class="form-check-label" for="QDemo_1b" style="padding-left: 15px">
                            380
                        </label>
                    </div>
                    <div class="form-control radio-center">
                        <input class="form-control-input" type="radio" id="QDemo_1c" name="QDemo_1" value="c"
                            {{old("QDemo_1")=='c'?'checked':''}} {{old("flag")?'disabled':''}} />
                        <label class="form-check-label" for="QDemo_1c" style="padding-left: 15px">
                            480
                        </label>
                    </div>
                    <div class="form-control" style="border-radius: 0px 0px 10px 10px;">
                        <input class="form-control-input" type="radio" id="QDemo_1d" name="QDemo_1" value="d"
                            {{old("QDemo_1")=='d'?'checked':''}} {{old("flag")?'disabled':''}} />
                        <label class="form-check-label" for="QDemo_1d" style="padding-left: 15px">
                            880
                        </label>
                    </div>
