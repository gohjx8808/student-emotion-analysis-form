...
<body class="background">
    <form class="form-background" action="" method="POST">
        ...
        <br />
        <h4 class="white-label">Part 2: SAM Test Pratice Round 1</h4>
        ...
        <video width="90%" height="50%" autoplay controls style="display:block;margin:0 auto">
            <source
                src="https://firebasestorage.googleapis.com/v0/b/student-emotion-analysis-d61dc.appspot.com/o/happy.mp4?alt=media&token=391ff6c7-7dfa-46d9-a0a0-3fe7e4fd3480"
                type="video/mp4">
        </video>
        <div style=" text-align: center;margin-top:20px">
            <button type="button" class="btn btn-primary" style="width:15%"
                onclick="window.location='{{ url("SAMVid1") }}'">
                Next
            </button>
        </div>
    </form>
