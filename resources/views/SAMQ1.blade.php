...
<body class="background">
    <form class="form-background" action="SAMQ1/save" method="POST">
        {{ csrf_field() }}
        ...
        <div style="text-align: center">
            ...
            <label for="SAM1" class="white-label">How strong do you feel?</label>
            <br />
            ...
            <label for="SAM1" class="white-label">How strong does the emotion controls you?</label>
            <br />
